...
static void node_memory_failure(void **state)
{
    ...
    POS pattern_pos = {1, 'a'};
    NODE * tested_node = SL_LIST_create_node(&pattern_pos, sizeof(POS));
...
static void position_memory_failure(void **state)
{
    ...
    NODE * expected_node = SL_LIST_create_node(&pattern_pos, sizeof(POS));
